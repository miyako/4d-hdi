![version](https://img.shields.io/badge/version-16%20%7C%2017-8331AE)
![scope](https://img.shields.io/badge/scope-HDI%20directory-blue)
...
Rows marked :white_check_mark: in **Updated** have been converted and are maintained; all other rows are original-only and are candidates for conversion. Originals marked *(JP)* are mirrored from [4D-JP/HDI](https://github.com/4D-JP/HDI) because 4D no longer hosts them.
...
|---|---|---|---|
| HDI_4DWP_Bookmarks | Creating, navigating and removing bookmarks in a 4D Write Pro document. | | [zip](https://downloads.4d.com/Demos/4D_v16/HDI_4DWP_Bookmarks.zip) |
...
| HDI_4DWP_InvoicesAndBookmarks | Building an invoice document by driving 4D Write Pro bookmarks from data. | | [zip (JP)](https://github.com/4D-JP/HDI/releases/download/16/HDI_4DWP_InvoicesAndBookmarks.zip) |
...
| HDI_DISTINCT_ATTRIBUTES | Retrieving the distinct values of an object-field attribute with `DISTINCT ATTRIBUTE VALUES`. | | [zip](https://downloads.4d.com/Demos/4D_v16/HDI_DISTINCT_ATTRIBUTES.zip) |
| HDI_GetPictureFormats | Listing the picture codecs available to 4D on the current platform. | | [zip](https://downloads.4d.com/Demos/4D_v16/HDI_GetPictureFormats.zip) |
| HDI_ListboxAutoResizeColumns | Distributing list box width across columns automatically when the form is resized. | | [zip](https://downloads.4d.com/Demos/4D_v16/HDI_ListboxAutoResizeColumns.zip) |
...
| HDI_ORDER_BY_ATTRIBUTE | Sorting a selection on an attribute inside an object field with `ORDER BY ATTRIBUTE`. | | [zip](https://downloads.4d.com/Demos/4D_v16_R2/HDI_ORDER_BY_ATTRIBUTE.zip) |
| HDI_QueryByAttribute | Querying on an attribute inside an object field with `QUERY BY ATTRIBUTE`, including indexed object attributes. | | [zip](https://downloads.4d.com/Demos/4D_v16_R2/HDI_QueryByAttribute.zip) |
...
| HDI_XML_Commands_thread_safe | The thread-safe XML command set used from preemptive processes. | | [zip](https://downloads.4d.com/Demos/4D_v17/HDI_XML_Commands_thread_safe.zip) |
