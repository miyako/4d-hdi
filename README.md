...
| HDI_4DWP_InvoicesAndBookmarks | Building an invoice document by driving 4D Write Pro bookmarks from data. | [HDI_4DWP_InvoicesAndBookmarks](https://github.com/miyako/HDI_4DWP_InvoicesAndBookmarks) | [zip](https://download.4d.com/Demos/4D_v16/WP_InvoicesAndBookmarks.zip) |
| HDI_4DWP_Print | Printing a 4D Write Pro document, including print preview and page ranges. | [HDI_4DWP_Print](https://github.com/miyako/HDI_4DWP_Print) | [zip](https://downloads.4d.com/Demos/4D_v16/HDI_4DWP_Print.zip) |
| HDI_4DWP_Thread_safety | Using 4D Write Pro commands inside preemptive processes. | [HDI_4DWP_Thread_safety](https://github.com/miyako/HDI_4DWP_Thread_safety) | [zip](https://downloads.4d.com/Demos/4D_v16/HDI_4DWP_Thread_safety.zip) |
| HDI_4DWP_ViewProperties | Switching a 4D Write Pro area between draft, page and embedded view modes, and toggling rulers, margins and invisible characters. | [HDI_4DWP_ViewProperties](https://github.com/miyako/HDI_4DWP_ViewProperties) | [zip](https://downloads.4d.com/Demos/4D_v16/HDI_4DWP_ViewProperties.zip) |
